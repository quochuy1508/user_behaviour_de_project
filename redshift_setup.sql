...
FROM DATA CATALOG DATABASE 'spectrumdb' iam_role 'arn:aws:iam::651760973596:role/leo-redshift' CREATE EXTERNAL DATABASE IF NOT EXISTS;
...
STORED AS textfile 
LOCATION 's3://leo-de-project/stage/user_purchase/' 
...
) STORED AS PARQUET LOCATION 's3://leo-de-project/stage/movie_review/';
